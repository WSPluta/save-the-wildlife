...
resource "oci_identity_policy" "devops_policy_in_compartment" {
  ...
  statements = [
    ...
    "allow dynamic-group ${local.dynamic_group_name} to manage object-family in compartment id ${var.compartment_ocid}",
    "allow dynamic-group ${local.dynamic_group_name} to manage logging-family in compartment id ${var.compartment_ocid}",
    ...
    "allow dynamic-group ${local.dynamic_group_name} to use generative-ai-family in compartment id ${var.compartment_ocid}",
    "allow dynamic-group ${local.dynamic_group_name} to read database-tools-family in compartment id ${var.compartment_ocid}"
  ]
}
