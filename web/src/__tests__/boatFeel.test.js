...
describe("boat feel layer", () => {
  it("starts the visual hull on the waterline instead of lerping down from the air", () => {
    ...
    expect(debug.waterlineClearance).toBeGreaterThanOrEqual(0.035);
    expect(debug.waterlineClearance).toBeLessThanOrEqual(0.05);
    expect(BOAT_FEEL_DEFAULTS.maxVisualY).toBeLessThan(0.08);
  });
  ...
  it("keeps the visual hull close to the rendered waterline instead of sinking", () => {
    ...
    expect(debug.y).toBeGreaterThanOrEqual(BOAT_FEEL_DEFAULTS.minVisualY);
    expect(debug.y).toBeLessThanOrEqual(BOAT_FEEL_DEFAULTS.maxVisualY);
    expect(debug.y).toBeGreaterThanOrEqual(0.018);
    expect(debug.y).toBeLessThanOrEqual(0.072);
    expect(debug.waterlineClearance).toBeGreaterThanOrEqual(0.012);
    expect(debug.waterlineClearance).toBeLessThanOrEqual(0.066);
  });
