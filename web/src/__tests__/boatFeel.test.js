...
describe("boat feel layer", () => {
  it("starts the visual hull on the waterline instead of lerping down from the air", () => {
    ...
    expect(BOAT_FEEL_DEFAULTS.maxVisualY).toBeLessThan(0);
    expect(Number((BOAT_FEEL_DEFAULTS.surfaceRippleY - BOAT_FEEL_DEFAULTS.maxVisualY).toFixed(3))).toBeGreaterThanOrEqual(0.015);
  });
