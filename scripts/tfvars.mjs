...
async function devopsTFvars() {
  ...
  const pafCommentaryDeadlineMs = process.env.PAF_COMMENTARY_DEADLINE_MS || "45000";
  ...
  const ociModelEndpointTimeoutMs = process.env.OCI_MODEL_ENDPOINT_TIMEOUT_MS || "30000";
