...
async function createPrivateAgentFactoryConfigFile(adbAdminPassword, adbService, adbWalletPassword) {
  ...
  try {
    const replacements = {
      ...
      TEMPLATE_PAF_COMMENTARY_DEADLINE_MS: process.env.PAF_COMMENTARY_DEADLINE_MS || "45000",
      ...
      TEMPLATE_OCI_MODEL_ENDPOINT_TIMEOUT_MS: process.env.OCI_MODEL_ENDPOINT_TIMEOUT_MS || "30000",
