...
async function createPrivateAgentFactoryConfigFile(adbAdminPassword, adbService, adbWalletPassword) {
  ...
  try {
    const replacements = {
      ...
      TEMPLATE_GENAI_MODEL_ID: process.env.OCI_GENAI_MODEL_ID || "cohere.command-a-03-2025",
      ...
      TEMPLATE_PAF_CANVAS_TIMEOUT_MS: process.env.PAF_CANVAS_TIMEOUT_MS || "750",
      TEMPLATE_PAF_COMMENTARY_DEADLINE_MS: process.env.PAF_COMMENTARY_DEADLINE_MS || "60000",
      TEMPLATE_PAF_CANVAS_RETURN_RESERVE_MS: process.env.PAF_CANVAS_RETURN_RESERVE_MS || "250",
      ...
      TEMPLATE_PAF_MODEL_ROUTE_MODE: process.env.PAF_MODEL_ROUTE_MODE || "primary",
      ...
      TEMPLATE_OCI_MODEL_ENDPOINT_TIMEOUT_MS: process.env.OCI_MODEL_ENDPOINT_TIMEOUT_MS || "60000",
