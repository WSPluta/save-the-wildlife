...
STWL_LOAD_TIERS=5,10,50,100,500,1000 \
npm --prefix bots run load:commentary
```

That run should fail if either primary or candidate output still reports `behavior-adapter` or `upstream_configured=false`.
